...
# Force all output to be presented in es_ES for the duration of this script. This avoids
# any "setting locale failed" errors while while this script is running, before we have
# installed support for all locales. Do not change thins setting!
